...
import bantadsBack.microConta.models.modelR.GerenteConsulta;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;

import java.util.List;

public interface GerenteRepositoryConsulta extends JpaRepository<GerenteConsulta, Long> {
    ...
    public List<GerenteConsulta> consultaGerente();
